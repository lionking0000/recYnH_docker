...
docker run -a stdout -v $dir:/src  -v $dir/share:/share -v /Volumes/users/smaurer/sequencing_data/Mireia_Garriga:/fastq lionking0000/recynh:0.1 /bin/bash -c "cd /src/src/; python ./recYnH.py align $*"


# cp /Volumes/users/lserrano/jyang/work/Mireia/src/output/2017-11-17_MiSeq/S1_WD_R?.fastq ./share/output/2017-11-17_MiSeq/tmp/
